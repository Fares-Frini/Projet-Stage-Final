...
public class BookController {
	...
	@GetMapping("/findbook/{pageNo}/{limit}/{sort}")
	public List<Book> findAllBook(@PathVariable int pageNo ,@PathVariable int limit,@PathVariable boolean sort)
	{
		return bookService.findallBooks(pageNo,limit,sort);
	}
	@GetMapping("/{id}")
